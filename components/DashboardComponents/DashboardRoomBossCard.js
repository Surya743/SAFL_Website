    ...
    <div className="block w-96 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 ">
      ...
      <div className="flex gap-2 mt-8">
        ...
        <div className="mb-1 text-base font-medium text-purple-800">
          Points Awarded: {props.details.points}
        </div>
      </div>
      ...
      {isCompleted ? (
        <div className="flex gap-2 mt-8">
          ...
          <div className="mb-1 text-base font-medium text-green-600">
            Game Cleared
          </div>
        </div>
      ) : (
        <div className="flex gap-2 mt-8">
          ...
          <div className="mb-1 text-base font-medium text-red-600">Pending</div>
        </div>
      )}
    </div>
  );
